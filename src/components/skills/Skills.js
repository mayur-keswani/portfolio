  ...
  const [skills, setSkills] = useState([
    {
      show: false,
      title: "LANGUAGES",
      languages: ["Javascript", "Typescript", "Cpp", "Java"],
      icon: "fas fa-folder",
    },
    {
      show: false,
    ...
    },
    {
      show: false,
      title: "OTHERS",
      languages: ["Git", "Postman", "Heroku", "npm", "Firebase"],
  ...
  return (
    <>
      ...
      <div className="mx-auto my-5 row" style={{ width: "100%" }}>
        {skills.map((skill) => {
          return (
            <div key={skill.title} className="col-12 col-lg-6 mt-3">
              <button
                className="accordion"
                ref={accordion}
              ...
              <div
                className="panel d-flex p-0 m-0"
                style={{ maxHeight: skill.show ? "900px" : null }}
              >
